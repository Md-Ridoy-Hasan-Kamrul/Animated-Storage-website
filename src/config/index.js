...
export const ROUTES = {
  ...
  RECTANGLE_BUTTONS: '/p/rectangle-buttons',
  LAUNCH_BUTTON_RECTANGLE_BUTTONS: '/p/launch-button-rectangle-buttons',
  DOT_BORDER_BUTTON_RECTANGLE_BUTTONS: '/p/dot-border-button-rectangle-buttons',
  FLOATING_DOTS_CTA_RECTANGLE_BUTTONS: '/p/floating-dots-cta-rectangle-buttons',
  SLIDING_TEXT_CTA_RECTANGLE_BUTTONS: '/p/sliding-text-cta-rectangle-buttons',
  GRADIENT_BEAM_CTA_RECTANGLE_BUTTONS: '/p/gradient-beam-cta-rectangle-buttons',
  GRADIENT_PILL_BUTTON_RECTANGLE_BUTTONS: '/p/gradient-pill-button-rectangle-buttons',
  GENERATE_BUTTON_RECTANGLE_BUTTONS: '/p/generate-button-rectangle-buttons',
  GLASSMORPHISM_CTA_RECTANGLE_BUTTONS: '/p/glassmorphism-cta-rectangle-buttons',
  SPINNING_BORDER_BUTTON_RECTANGLE_BUTTONS: '/p/spinning-border-button-rectangle-buttons',
  GRADIENT_CTA_RECTANGLE_BUTTONS: '/p/gradient-cta-rectangle-buttons',
  LUMEN_CTA_RECTANGLE_BUTTONS: '/p/lumen-cta-rectangle-buttons',
  TROCHIL_SIGNAL_RECTANGLE_BUTTONS: '/p/trochil-signal-rectangle-buttons',
  TIDEFORM_OUTLINE_RECTANGLE_BUTTONS: '/p/tideform-outline-rectangle-buttons',
  MERIDIAN_KEYCAP_PRIMARY_RECTANGLE_BUTTONS: '/p/meridian-keycap-primary-rectangle-buttons',
  MERIDIAN_KEYCAP_SECONDARY_RECTANGLE_BUTTONS: '/p/meridian-keycap-secondary-rectangle-buttons',
  HALVORSEN_ARROW_PILL_RECTANGLE_BUTTONS: '/p/halvorsen-arrow-pill-rectangle-buttons',
  EMBER_KEYCAP_RECTANGLE_BUTTONS: '/p/ember-keycap-rectangle-buttons',
  BLOOM_OUTLINE_BUTTON_RECTANGLE_BUTTONS: '/p/bloom-outline-button-rectangle-buttons',
  PLAY_CIRCLE_LIQUID_METAL_BUTTON: '/p/play-circle-liquid-metal-button',
  SIGN_UP_PILL_LIQUID_METAL_BUTTON: '/p/sign-up-pill-liquid-metal-button',
  LIQUID_ORB_LIQUID_METAL_BUTTON: '/p/liquid-orb-liquid-metal-button',
  STAR_PORTAL: '/p/star-portal',
  IGNITION_BUTTON: '/p/ignition-button',
  INDUCTION_BUTTON: '/p/induction-button',
  PLASMA_BUTTON: '/p/plasma-button',
  TACTILE_BUTTON: '/p/tactile-button',
  RAKING_LIGHT_PILL: '/p/raking-light-pill',
  THINKING_BUTTON: '/p/thinking-button',
  MATTE_RISE: '/p/matte-rise',
  GLITCH_FALL: '/p/glitch-fall',
  RISO_SWEEP: '/p/riso-sweep',
  HALFTONE_LOOP: '/p/halftone-loop',
