/**
 * Exact Heritage Grove footer design prompt — used for “Copy prompt”.
 * Do not alter characters.
 */
export const HERITAGE_GROVE_PROMPT = `Create exactly ONE file, named \`index.html\`, in the project root.
...
export default HERITAGE_GROVE_PROMPT;
