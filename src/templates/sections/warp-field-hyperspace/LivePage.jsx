...
import './warp-field-hyperspace.css';
import { PAGE_CLASS, SHADER_FRAME_CLASS, WARP_FIELD_HYPERSPACE_PROPS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <WarpFieldBackground {...WARP_FIELD_HYPERSPACE_PROPS} />
      </div>
    </div>
  );
});
