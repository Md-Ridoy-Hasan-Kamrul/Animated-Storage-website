export const WARP_FIELD_DEFAULT_PROMPT = `# Integrate <WarpFieldBackground /> from ThreeUI using its exact source
...
Reference brief:
The original hero warp: 400 emerald streaks and 40 luminous tiles through deep-space fog.
