...
describe('Warp Field Default Variant packaged assets', () => {
  ...
  it('keeps the verified component and renderer provenance', () => {
    const component = fs.readFileSync(
      path.join(
        ROOT,
        'src/templates/sections/warp-field-default/sources/WarpFieldBackground.tsx.txt',
      ),
      'utf8',
    );
    ...
    expect(renderer).toContain('import * as THREE from "three128"');
  });
});
