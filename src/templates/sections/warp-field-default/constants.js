/** Warp Field Default Variant — host + provenance constants. */

export const CARD_ID = 'warp-field-default';
export const CARD_TITLE = 'Warp Field Default Variant';
export const PAGE_TITLE = 'Warp Field Default Variant — Kmotion';
export const DETAIL_FALLBACK = '/templates/warp-field-default';

export const PAGE_CLASS = 'warp-field-default-page';
export const PAGE_HTML_CLASS = 'warp-field-default-html';
export const FRAMED_HTML_CLASS = 'warp-field-default-framed';
...
export const WARP_FIELD_VARIANT = 'streaks';
...
export const WARP_FIELD_DEFAULT_PROPS = {
  speed: 15,
  streakOpacity: 0.6,
  tileOpacity: 0.9,
  fov: 75,
...
export const ASSET_MANIFEST = [
  {
    path: 'src/templates/sections/warp-field-default/sources/WarpFieldBackground.tsx.txt',
    bytes: WARP_FIELD_COMPONENT_BYTES,
    sha256: WARP_FIELD_COMPONENT_SHA256,
  },
  {
    path: 'src/templates/sections/warp-field-default/sources/warpFieldRenderer.ts.txt',
    bytes: WARP_FIELD_RENDERER_BYTES,
    sha256: WARP_FIELD_RENDERER_SHA256,
  },
  {
    path: 'src/templates/sections/warp-field-default/sources/threeui.css',
...
export const PREVIEW_STILL = '/images/Assets Warp Field Default Variant/WarpFieldDefaultVariant.png';
