export const WARP_FIELD_KEYCAP_DRIFT_PROMPT = `# Integrate <WarpFieldBackground /> from ThreeUI using its exact source
...
Reference brief:
72 lit mechanical keycaps tumbling through a 900-spark particle wake.
