export const WARP_FIELD_LETTER_STORM_PROMPT = `# Integrate <WarpFieldBackground /> from ThreeUI using its exact source
...
Reference brief:
160 tumbling glyphs wandering off the rails while the streak field keeps the corridor moving.
