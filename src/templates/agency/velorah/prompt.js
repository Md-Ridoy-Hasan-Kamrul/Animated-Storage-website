/**
 * Exact Velorah Agency hero design prompt — used for “Copy prompt”.
 * Do not alter characters.
 */
export const VELORAH_PROMPT = `Create a single-page hero section with a fullscreen looping background video, glassmorphic navigation, and cinematic typography. Use React + Vite + Tailwind CSS + TypeScript with shadcn/ui.
