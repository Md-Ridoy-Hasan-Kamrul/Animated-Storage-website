...
export const systems = {
  battery: {
    ...
    description:
      'A traction battery stores electrical energy and supplies it to the drive system. In this concept, it sits low beneath the cabin.',
    ...
    points: [
      ...
      {
        label: 'High-voltage connection',
        text: 'Orange connections mark the high-voltage electrical path in this illustration.',
        x: 27,
        y: 55,
      },
  ...
  drive: {
    ...
    description:
      'The electric motor turns electrical energy into rotation. A reduction gear transfers that rotation to the wheels.',
  ...
  optics: {
    ...
    description:
      'Inside this concept headlamp, an LED module produces light and a projection lens shapes it into a controlled beam.',
...
export const systemIds = ['battery', 'drive', 'optics'];

export const hotspots = [
  ...['battery', 'drive'].map((id) => ({
    id,
    index: systems[id].index,
    label: systems[id].label,
    anchor: systems[id].anchor,
    target: id,
  })),
...
export const ABOUT_DECOR = { moon: PREVIEW_STILL, group: '/media/drive-blue.png' };
