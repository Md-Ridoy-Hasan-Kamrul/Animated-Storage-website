export const WOVEN_CLOTH_IRIDESCENT_PROMPT = `# Integrate <WovenCloth /> from ThreeUI using its exact source
...
Reference brief:
A five-harness satin under a painted studio environment: a thin-film interference layer whose thickness sweeps one full order across the width, so the colour travels over the folds while the wordmark stays a tone-on-tone jacquard.
