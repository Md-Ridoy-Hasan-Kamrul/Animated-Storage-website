...
describe('Iridescent Silk WovenCloth host', () => {
  it('loads the iridescent companion document URL', () => {
    render(<WovenCloth variant="iridescent" />);
  ...
  it('exposes the woven-cloth-iridescent host class', () => {
    const { container } = render(<WovenCloth />);
    expect(container.querySelector('.woven-cloth-iridescent')).toBeTruthy();
  });
...
describe('Iridescent Silk Woven Cloth LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.woven-cloth-iridescent-page')).toBeTruthy();
