export const WOVEN_CLOTH_ATELIER_PROMPT = `# Integrate <WovenCloth /> from ThreeUI using its exact source
...
Reference brief:
The same sheet cut and sewn: three linen panels joined by flat-felled seams and topstitching, an indigo heading tape on the hoist with brass grommets and a mast, hemmed at the fly, and a woven label tacked on at the corner.
