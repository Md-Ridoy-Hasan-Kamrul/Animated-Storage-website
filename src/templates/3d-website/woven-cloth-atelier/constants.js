/** Atelier Flag Woven Cloth — companion host + provenance constants. */

export const CARD_ID = 'woven-cloth-atelier';
export const CARD_TITLE = 'Atelier Flag Woven Cloth';
export const PAGE_TITLE = 'Atelier Flag Woven Cloth — Kmotion';
export const DETAIL_FALLBACK = '/templates/woven-cloth-atelier';

export const PAGE_CLASS = 'woven-cloth-atelier-page';
export const PAGE_HTML_CLASS = 'woven-cloth-atelier-html';
export const FRAMED_HTML_CLASS = 'woven-cloth-atelier-framed';
export const SHADER_FRAME_CLASS = 'shader-frame';
export const HOST_CLASS = 'threeui-background woven-cloth-atelier';
export const FRAME_CLASS = 'woven-cloth-atelier__frame';

export const PAGE_BG = '#12100d';
export const PAGE_INK = '#e8dcc4';
export const HOST_BACKGROUND = '#12100d';

export const FRAME_SANDBOX = 'allow-scripts';
export const FRAME_TITLE = 'Woven Cloth atelier flag';
export const HOST_ARIA_LABEL = 'Interactive Atelier Flag woven cloth';
export const HOST_ROLE = 'group';

export const SOURCE_URL = '/effects/woven-cloth-atelier.html';
export const SOURCE_REVISION = '9bfd56ef7579';
export const VARIANT_ID = 'atelier';
...
export const FOCUSED_DOCUMENT_SHA256 = WOVEN_CLOTH_ATELIER_SHA256;
export const FOCUSED_DOCUMENT_BYTES = 18979;

export const INTERSECTION_ROOT_MARGIN = '80px';

export const ASSET_MANIFEST = [
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/lumina-weavers-cloth.html',
    bytes: 17470,
    sha256: LUMINA_WEAVERS_CLOTH_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/WovenCloth.tsx.txt',
    bytes: 2993,
    sha256: WOVEN_CLOTH_TSX_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/NeuformCraftEffects.tsx.txt',
    bytes: 10720,
    sha256: NEUFORM_CRAFT_EFFECTS_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/woven-cloth-iridescent.html',
    bytes: 21728,
    sha256: WOVEN_CLOTH_IRIDESCENT_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/woven-cloth-atelier.html',
    bytes: FOCUSED_DOCUMENT_BYTES,
    sha256: WOVEN_CLOTH_ATELIER_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/woven-cloth-washi.html',
    bytes: 18332,
    sha256: WOVEN_CLOTH_WASHI_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth-atelier/sources/threeui.css',
    bytes: 40715,
    sha256: THREEUI_CSS_SHA256,
  },
  {
    path: 'public/effects/woven-cloth-atelier.html',
    bytes: FOCUSED_DOCUMENT_BYTES,
...
export const PREVIEW_STILL =
  '/images/Assets%20Atelier%20Flag%20Woven%20Cloth/AtelierFlagWovenCloth.png';
