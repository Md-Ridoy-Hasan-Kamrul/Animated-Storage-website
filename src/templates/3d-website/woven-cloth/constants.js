/** Woven Cloth — host + provenance constants. */

export const CARD_ID = 'woven-cloth';
export const CARD_TITLE = 'Woven Cloth';
export const PAGE_TITLE = 'Woven Cloth — Kmotion';
export const DETAIL_FALLBACK = '/templates/woven-cloth';

export const PAGE_CLASS = 'woven-cloth-page';
export const PAGE_HTML_CLASS = 'woven-cloth-html';
export const FRAMED_HTML_CLASS = 'woven-cloth-framed';
export const SHADER_FRAME_CLASS = 'shader-frame';
export const HOST_CLASS = 'threeui-background woven-cloth';
export const FRAME_CLASS = 'woven-cloth__frame';

export const PAGE_BG = '#16090b';
export const PAGE_INK = '#e8dcc4';
export const HOST_BACKGROUND = '#16090b';

export const FRAME_SANDBOX = 'allow-scripts';
export const FRAME_TITLE = 'Woven Cloth kinetic textile';
export const HOST_ARIA_LABEL = 'Interactive Woven Cloth kinetic textile';
export const HOST_ROLE = 'group';

export const SOURCE_URL = '/effects/woven-cloth.html';
...
/** Focused document = canonical + woven-cloth label remap + ThreeUI focus adapter. */
export const FOCUSED_DOCUMENT_SHA256 =
  '5deffeac66e69efbd796020c5176bd15459f82da51bc88286992d4b019803ac6';
export const FOCUSED_DOCUMENT_BYTES = 20152;

export const INTERSECTION_ROOT_MARGIN = '80px';

export const ASSET_MANIFEST = [
  {
    path: 'src/templates/3d-website/woven-cloth/sources/lumina-weavers-cloth.html',
    bytes: 17470,
    sha256: LUMINA_WEAVERS_CLOTH_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/WovenCloth.tsx.txt',
    bytes: 2993,
    sha256: WOVEN_CLOTH_TSX_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/NeuformCraftEffects.tsx.txt',
    bytes: 10720,
    sha256: NEUFORM_CRAFT_EFFECTS_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/woven-cloth-iridescent.html',
    bytes: 21728,
    sha256: WOVEN_CLOTH_IRIDESCENT_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/woven-cloth-atelier.html',
    bytes: 18979,
    sha256: WOVEN_CLOTH_ATELIER_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/woven-cloth-washi.html',
    bytes: 18332,
    sha256: WOVEN_CLOTH_WASHI_SHA256,
  },
  {
    path: 'src/templates/3d-website/woven-cloth/sources/threeui.css',
    bytes: 40715,
    sha256: THREEUI_CSS_SHA256,
  },
  {
    path: 'public/effects/woven-cloth.html',
    bytes: FOCUSED_DOCUMENT_BYTES,
    sha256: FOCUSED_DOCUMENT_SHA256,
  },
];

export const PREVIEW_STILL = '/images/Assets%20Woven%20Cloth/WovenCloth.png';

export const BACK_BUTTON_CLASS =
  'absolute top-4 left-4 z-50 flex items-center gap-2 rounded-full bg-black/30 px-3 py-2 text-sm text-[#e8dcc4] backdrop-blur-md transition hover:bg-black/45';
