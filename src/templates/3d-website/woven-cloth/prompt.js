export const WOVEN_CLOTH_PROMPT = `# Integrate <WovenCloth /> from ThreeUI using its exact source
...
Reference brief:
The packaged Neuform export, untouched: an ivory banner with a crimson hem and the Woven Cloth wordmark printed into the weave, pinned along its top edge.
