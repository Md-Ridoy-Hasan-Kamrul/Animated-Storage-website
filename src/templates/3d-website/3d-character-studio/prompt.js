/**
 * Exact 3D Character Studio / Mainframe design prompt — used for “Copy prompt”.
 * Do not alter characters.
 */
export const MAINFRAME_PROMPT = `Build a full-screen hero landing page for a creative agency called "Mainframe" using React, TypeScript, Vite, and Tailwind CSS. Here is every detail:
