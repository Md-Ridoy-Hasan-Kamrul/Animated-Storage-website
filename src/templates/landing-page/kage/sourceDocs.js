/** Source-docs bodies for the KAGE details panel (Usage / Code / Skill.md). */

export const KAGE_USAGE = `import { KageLandingPage } from "@designcodeio/threeui";
