...
import { ABOUT_DECOR } from '../content';
...
const AboutSection = () => (
  ...
  >
    ...
    >
      <img src={ABOUT_DECOR.moon} alt="" className="h-auto w-full" />
    </FadeIn>
    <FadeIn
      delay={0.25}
      x={-80}
    ...
    >
      <img src={ABOUT_DECOR.object} alt="" className="h-auto w-full" />
    </FadeIn>
    <FadeIn
      delay={0.15}
      x={80}
    ...
    >
      <img src={ABOUT_DECOR.lego} alt="" className="h-auto w-full" />
    </FadeIn>
    <FadeIn
      delay={0.3}
      x={80}
    ...
    >
      <img src={ABOUT_DECOR.group} alt="" className="h-auto w-full" />
    </FadeIn>
    ...
    <div className="relative z-10 flex w-full max-w-4xl flex-col items-center text-center">
      ...
      <div className="mt-10 flex w-full flex-col items-center sm:mt-14 md:mt-16">
        <AnimatedText
          text={ABOUT_TEXT}
