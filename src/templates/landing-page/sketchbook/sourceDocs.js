/** Source-docs bodies for the Sketchbook details panel (Usage / Code / Skill.md). */

export const SKETCHBOOK_USAGE = `import { MengToSketchbookLandingPage } from "@designcodeio/threeui";
