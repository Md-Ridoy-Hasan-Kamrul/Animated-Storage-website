/**
 * Prompt design — exact copy for gallery "Copy full prompt".
 * Do not alter this string when building the live page.
 */
export const PROMPT_ARCHIVE_PROMPT = `### Overview
...
export default PROMPT_ARCHIVE_PROMPT;
