/** Source-docs bodies for the Working Volumes details panel (Usage / Code / Skill.md). */

export const COMPLETE_SHELF_USAGE = `import { CompleteShelfLandingPage } from "@designcodeio/threeui";
...
export const COMPLETE_SHELF_SKILL = `---
