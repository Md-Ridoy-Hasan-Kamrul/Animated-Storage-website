...
describe('Turkish Tower Landscape packaged assets', () => {
  ...
  it('serves the shared Towers document with Turkey style + country boot', () => {
    ...
    expect(html).toContain("id:'TURKEY'");
    expect(html).toContain('buildCami');
  ...
  it('keeps provenance Towers.html identical to the registered source', () => {
    ...
    expect(provenance).toContain("id:'TURKEY'");
    expect(provenance).toContain('buildCami');
