...
export const TURKEY_JAPANESE_TOWER_LANDSCAPE_PROMPT = `# Integrate <JapaneseTowerLandscape /> from ThreeUI using its exact source
...
Reference brief:
An Ottoman mosque with limestone ashlar, İznik tile, a lead dome, and twin pencil minarets.
