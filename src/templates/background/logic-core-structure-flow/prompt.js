...
export const LOGIC_CORE_STRUCTURE_FLOW_PROMPT = `# Integrate <StructureFlowCollection /> from ThreeUI using its exact source
...
Reference brief:
An isometric platform, illuminated logic core, and orbiting nodes.
...
Complete registered source bundle: [https://threeui.com/source-code/logic-core.json](https://threeui.com/source-code/logic-core.json)
...
- \`src/shaders/neuform-isolated/sources/platform-core.html\` — canonical-source · SHA-256 \`0f6889add89b389ba687fc6828c1f9415e5d8d54005492a91f3a79641ba42e31\`
