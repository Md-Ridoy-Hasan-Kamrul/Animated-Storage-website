export const TERMINAL_CRT_PROMPT = `# Integrate <CrtBackground /> from ThreeUI using its exact source
...
Reference brief:
The authored 19-row Zion boot log typing itself onto green phosphor, now resolved at the full backing resolution so the glyph cores stay crisp behind the grille.
