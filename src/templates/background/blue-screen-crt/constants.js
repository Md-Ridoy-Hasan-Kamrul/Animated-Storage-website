/** Blue Screen CRT — host + provenance constants. */

export const CARD_ID = 'blue-screen-crt';
export const CARD_TITLE = 'Blue Screen CRT';
export const PAGE_TITLE = 'Blue Screen CRT — Kmotion';
export const DETAIL_FALLBACK = '/templates/blue-screen-crt';

export const PAGE_CLASS = 'blue-screen-crt-page';
export const PAGE_HTML_CLASS = 'blue-screen-crt-html';
export const FRAMED_HTML_CLASS = 'blue-screen-crt-framed';
export const SHADER_FRAME_CLASS = 'shader-frame';
export const HOST_CLASS = 'threeui-background crt crt-blue-screen';

export const PAGE_BG = '#050a24';
export const PAGE_INK = '#9ec0ff';

export const SOURCE_REVISION = '860a1eb1d4c9';
export const VARIANT_ID = 'blue-screen';
...
export const BLUE_SCREEN_CRT_DEFAULT_PROPS = {
  variant: 'blue-screen',
  speed: 1,
  motion: 1,
  hue: 0,
...
const SRC = 'src/templates/background/blue-screen-crt/sources';
...
export const PREVIEW_STILL = '/images/Assets%20Blue%20Screen%20CRT/BlueScreenCRT.png';

export const BACK_BUTTON_CLASS =
  'absolute top-4 left-4 z-50 flex items-center gap-2 rounded-full bg-black/40 px-3 py-2 text-sm text-[#9ec0ff] backdrop-blur-md transition hover:bg-black/55';
