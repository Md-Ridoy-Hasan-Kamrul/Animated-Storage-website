...
import './blue-screen-crt.css';
import { BLUE_SCREEN_CRT_DEFAULT_PROPS, PAGE_CLASS, SHADER_FRAME_CLASS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <CrtBackground {...BLUE_SCREEN_CRT_DEFAULT_PROPS} />
      </div>
    </div>
  );
});
