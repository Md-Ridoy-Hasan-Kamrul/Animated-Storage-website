...
export const INTERFACE_LINES_DEFAULTS = {
...
const DEFAULT_SOURCE_URL = '/effects/interface-lines.html';
const HOST_BACKGROUND = '#050505';
const CONTROLS_TYPE = 'threeui-controls';
const VARIANT_ID = 'interface-lines';
...
/**
 * CSP-safe host for the prebuilt Interface Lines document.
 * Focused HTML lives at `/effects/interface-lines.html` (srcDoc scripts blocked).
 */
export function ConstellationField({
  variant = INTERFACE_LINES_DEFAULTS.variant,
  mode = INTERFACE_LINES_DEFAULTS.mode,
  speed = INTERFACE_LINES_DEFAULTS.speed,
  size = INTERFACE_LINES_DEFAULTS.size,
  length = INTERFACE_LINES_DEFAULTS.length,
  density = INTERFACE_LINES_DEFAULTS.density,
  opacity = INTERFACE_LINES_DEFAULTS.opacity,
  hue = INTERFACE_LINES_DEFAULTS.hue,
  saturation = INTERFACE_LINES_DEFAULTS.saturation,
  brightness = INTERFACE_LINES_DEFAULTS.brightness,
  className = '',
  style,
