...
import { INTERFACE_LINES_DEFAULT_PROPS, SOURCE_URL, VARIANT_ID } from '../constants';
...
describe('Interface Lines ConstellationField host', () => {
  it('mounts the interface-lines iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <ConstellationField {...INTERFACE_LINES_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
    ...
    expect(frame.getAttribute('title')).toBe('Interface Lines');
  });
...
describe('Interface Lines Constellation Field LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.interface-lines-constellation-field-page')).toBeTruthy();
