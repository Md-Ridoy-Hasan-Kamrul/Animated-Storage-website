export const INTERFACE_LINES_CONSTELLATION_FIELD_PROMPT = `# Integrate <ConstellationField /> from ThreeUI using its exact source
...
Reference brief:
A faint interface line-field background for dense system UI stages.
...
Complete registered source bundle: [https://threeui.com/source-code/interface-lines.json](https://threeui.com/source-code/interface-lines.json)
...
- \`src/shaders/neuform-isolated/sources/interface-lines.html\` — canonical-source · SHA-256 \`608cbc6976996b8a5b6c4aaba4bee4d6f2dd44579b819df45914f35bc310d2cc\`
