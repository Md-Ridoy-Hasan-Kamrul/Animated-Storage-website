...
export const CHINA_JAPANESE_TOWER_LANDSCAPE_PROMPT = `# Integrate <JapaneseTowerLandscape /> from ThreeUI using its exact source
...
Reference brief:
A Chinese pagoda in vermilion lacquer and green glaze beneath a gilt finial.
