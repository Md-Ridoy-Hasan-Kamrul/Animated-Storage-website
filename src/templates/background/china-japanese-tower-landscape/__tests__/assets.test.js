...
describe('Chinese Tower Landscape packaged assets', () => {
  ...
  it('serves the shared Towers document with China style + country boot', () => {
    ...
    expect(html).toContain('buildPagoda');
  ...
  it('keeps provenance Towers.html identical to the registered source', () => {
    ...
    expect(provenance).toContain("id:'CHINA'");
    expect(provenance).toContain('buildPagoda');
