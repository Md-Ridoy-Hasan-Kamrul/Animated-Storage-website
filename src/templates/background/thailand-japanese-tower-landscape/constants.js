export const CARD_ID = 'thailand-japanese-tower-landscape';
export const CARD_TITLE = 'Thai Tower Landscape';
export const DETAIL_FALLBACK = '/templates/thailand-japanese-tower-landscape';
export const PAGE_TITLE = 'Thailand — Japanese Tower Landscape';
export const PAGE_BG = '#ecdcbc';
export const PAGE_INK = '#2e2515';
export const PAGE_HTML_CLASS = 'thailand-japanese-tower-landscape-html';
export const FRAMED_HTML_CLASS = 'thailand-japanese-tower-landscape-framed';
export const PAGE_CLASS = 'thailand-japanese-tower-landscape-page';
...
export const BACK_BUTTON_CLASS =
  'thailand-japanese-tower-landscape-back fixed left-4 top-4 z-[70] inline-flex items-center gap-2 rounded-full border border-[#2e2515]/20 bg-[#ecdcbc]/80 px-3.5 py-2 text-sm font-medium text-[#2e2515] backdrop-blur-md transition-colors hover:border-[#2e2515]/40 hover:bg-[#f7e5c6]/90 md:left-6 md:top-6';
...
export const FRAME_TITLE = 'Thai prang in a procedural landscape';
export const TOWER_COUNTRY = 'thailand';
export const VARIANT_BACKGROUND = '#ecdcbc';

export const DETAIL_CARD_IMAGE_COUNT = 8;
export const PREVIEW_STILL =
  '/images/Assets Thai Tower Landscape/JapaneseTowerLandscape.png';
...
export const THAI_TOWER_DEFAULT_PROPS = {
  country: 'thailand',
};
