...
describe('Thai Tower Landscape packaged assets', () => {
  ...
  it('serves the shared Towers document with Thailand style + country boot', () => {
    ...
    expect(html).toContain("id:'THAI'");
    expect(html).toContain('buildWat');
  ...
  it('keeps provenance Towers.html identical to the registered source', () => {
    ...
    expect(provenance).toContain("id:'THAI'");
    expect(provenance).toContain('buildWat');
