...
export const THAILAND_JAPANESE_TOWER_LANDSCAPE_PROMPT = `# Integrate <JapaneseTowerLandscape /> from ThreeUI using its exact source
...
Variant: **Thailand** (\`thailand\`)
Runtime: Three.js r149 + Canvas 2D
Source revision: \`SHA-256 7810e7163c02\`

Reference brief:
A Thai prang rising from a stepped plinth into a richly detailed gold spire.
