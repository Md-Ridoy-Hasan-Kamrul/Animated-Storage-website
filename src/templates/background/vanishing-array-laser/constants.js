/** Vanishing Array Laser — host + provenance constants. */

export const CARD_ID = 'vanishing-array-laser';
export const CARD_TITLE = 'Vanishing Array Laser';
export const PAGE_TITLE = 'Vanishing Array Laser — Kmotion';
export const DETAIL_FALLBACK = '/templates/vanishing-array-laser';

export const PAGE_CLASS = 'vanishing-array-laser-page';
export const PAGE_HTML_CLASS = 'vanishing-array-laser-html';
export const FRAMED_HTML_CLASS = 'vanishing-array-laser-framed';
...
export const PAGE_INK = '#c9a0ff';
export const LASER_VARIANT_BG = '#020305';

export const SOURCE_REVISION = '70cc015d5175';
export const VARIANT_ID = 'vanishing-array';
export const VARIANT_INDEX = 1;
...
export const VANISHING_ARRAY_DEFAULT_PROPS = {
...
export const LASER_VARIANT_DEFAULTS = { ...VANISHING_ARRAY_DEFAULT_PROPS };

const SRC = 'src/templates/background/vanishing-array-laser/sources';
...
export const PREVIEW_STILL_DISK =
  'public/images/Assets Vanishing Array Laser/VanishingArrayLaser.png';
