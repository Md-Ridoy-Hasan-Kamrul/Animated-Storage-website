...
export const VIETNAM_JAPANESE_TOWER_LANDSCAPE_PROMPT = `# Integrate <JapaneseTowerLandscape /> from ThreeUI using its exact source
...
Variant: **Vietnam** (\`vietnam\`)
Runtime: Three.js r149 + Canvas 2D
Source revision: \`SHA-256 7810e7163c02\`

Reference brief:
A Vietnamese tháp with seven octagonal Huế lime-wash storeys and lifted tiled eaves.
