export const CARD_ID = 'vietnam-japanese-tower-landscape';
export const CARD_TITLE = 'Vietnamese Tower Landscape';
export const DETAIL_FALLBACK = '/templates/vietnam-japanese-tower-landscape';
export const PAGE_TITLE = 'Vietnam — Japanese Tower Landscape';
export const PAGE_BG = '#ecdcbc';
export const PAGE_INK = '#2e2515';
export const PAGE_HTML_CLASS = 'vietnam-japanese-tower-landscape-html';
export const FRAMED_HTML_CLASS = 'vietnam-japanese-tower-landscape-framed';
export const PAGE_CLASS = 'vietnam-japanese-tower-landscape-page';
...
export const BACK_BUTTON_CLASS =
  'vietnam-japanese-tower-landscape-back fixed left-4 top-4 z-[70] inline-flex items-center gap-2 rounded-full border border-[#2e2515]/20 bg-[#ecdcbc]/80 px-3.5 py-2 text-sm font-medium text-[#2e2515] backdrop-blur-md transition-colors hover:border-[#2e2515]/40 hover:bg-[#f7e5c6]/90 md:left-6 md:top-6';
...
export const FRAME_TITLE = 'Vietnamese tháp in a procedural landscape';
export const TOWER_COUNTRY = 'vietnam';
...
export const VIETNAMESE_TOWER_DEFAULT_PROPS = {
  country: 'vietnam',
};
