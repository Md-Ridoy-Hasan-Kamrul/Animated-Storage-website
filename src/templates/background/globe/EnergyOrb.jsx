...
export function EnergyOrb({
  ...
  const options = optionsRef.current;
  return <div ref={hostRef} className={`threeui-background energy-orb${className ? ` ${className}` : ""}`} style={{
    background: "#05030e"
  }}>
      <canvas ref={starCanvasRef} className="energy-orb__stars" aria-hidden="true" style={{
      zIndex: 0,
      pointerEvents: "none"
    }} />
      <canvas ref={canvasRef} className="energy-orb__shader" aria-hidden="true" style={{
      zIndex: 1,
