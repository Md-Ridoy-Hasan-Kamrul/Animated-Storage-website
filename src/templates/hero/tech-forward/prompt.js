export const TECH_FORWARD_PROMPT = `Create a full-screen hero section landing page using React, Vite, and Framer Motion (\`motion\` package). Use plain CSS (no Tailwind). The font is Inter (weights 300, 400, 500, 600) from Google Fonts. The design is minimal black-and-white with a full-viewport background video.
