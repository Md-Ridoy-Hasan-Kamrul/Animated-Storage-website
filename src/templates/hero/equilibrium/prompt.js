export const EQUILIBRIUM_PROMPT = `Build a full-screen, single-page React + TypeScript + Vite + Tailwind CSS hero section with a "liquid glass" aesthetic on top of a looping background video. Use \`lucide-react\` for icons. No other UI libraries.
