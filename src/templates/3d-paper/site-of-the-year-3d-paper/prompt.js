export const SITE_OF_THE_YEAR_3D_PAPER_PROMPT = `# Integrate <ThreeDPaper /> from ThreeUI using its exact source
...
Variant: **Site of the Year** (\`site-of-the-year\`)
Runtime: Bundled Three.js r149 + custom GLSL + CanvasTexture
Source revision: \`SHA-256 8ec1b71c0dbc\`

Reference brief:
A graphic Site of the Year award sheet with vivid lime scoring details, season XP, winner metadata, and the same tactile translucent paper motion.
