/** Site of the Year 3D Paper — host + provenance constants. */

export const CARD_ID = 'site-of-the-year-3d-paper';
export const CARD_TITLE = 'Site of the Year 3D Paper';
export const PAGE_TITLE = 'Site of the Year 3D Paper — Kmotion';
export const DETAIL_FALLBACK = '/templates/site-of-the-year-3d-paper';

export const PAGE_CLASS = 'site-of-the-year-3d-paper-page';
export const PAGE_HTML_CLASS = 'site-of-the-year-3d-paper-html';
export const FRAMED_HTML_CLASS = 'site-of-the-year-3d-paper-framed';
...
export const FRAME_TITLE = 'Site of the Year 3D Paper';
export const HOST_ARIA_LABEL = '3D Paper Site of the Year interactive certificate';

export const SOURCE_URL = '/effects/site-of-the-year-3d-paper.html';
export const SOURCE_REVISION = '8ec1b71c0dbc';
export const PAPER_VARIANT = 'site-of-the-year';
...
export const ASSET_MANIFEST = [
  {
    path: 'public/effects/site-of-the-year-3d-paper.html',
    bytes: 633404,
    sha256: PAPER_HTML_SHA256,
  },
  {
    path: 'src/templates/3d-paper/site-of-the-year-3d-paper/sources/threeui.css',
    bytes: 40715,
    sha256: THREEUI_CSS_SHA256,
  },
  {
    path: 'src/templates/3d-paper/site-of-the-year-3d-paper/sources/ThreeDPaper.tsx.txt',
    bytes: 3185,
