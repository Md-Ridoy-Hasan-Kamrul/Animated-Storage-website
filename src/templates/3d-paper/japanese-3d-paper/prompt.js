export const JAPANESE_3D_PAPER_PROMPT = `# Integrate <ThreeDPaper /> from ThreeUI using its exact source
...
Variant: **Japanese** (\`japanese\`)
Runtime: Bundled Three.js r149 + custom GLSL + CanvasTexture
Source revision: \`SHA-256 8ec1b71c0dbc\`

Reference brief:
A Japanese recognition certificate with vertical display type, warm gold accents, bilingual details, procedural translucency, and direct inertial interaction.
