/** Japanese 3D Paper — host + provenance constants. */

export const CARD_ID = 'japanese-3d-paper';
export const CARD_TITLE = 'Japanese 3D Paper';
export const PAGE_TITLE = 'Japanese 3D Paper — Kmotion';
export const DETAIL_FALLBACK = '/templates/japanese-3d-paper';

export const PAGE_CLASS = 'japanese-3d-paper-page';
export const PAGE_HTML_CLASS = 'japanese-3d-paper-html';
export const FRAMED_HTML_CLASS = 'japanese-3d-paper-framed';
...
export const FRAME_TITLE = 'Japanese 3D Paper';
export const HOST_ARIA_LABEL = '3D Paper Japanese recognition certificate';

export const SOURCE_URL = '/effects/japanese-3d-paper.html';
export const SOURCE_REVISION = '8ec1b71c0dbc';
export const PAPER_VARIANT = 'japanese';
...
export const ASSET_MANIFEST = [
  {
    path: 'public/effects/japanese-3d-paper.html',
    bytes: 633704,
    sha256: PAPER_HTML_SHA256,
  },
  {
    path: 'src/templates/3d-paper/japanese-3d-paper/sources/threeui.css',
    bytes: 40715,
    sha256: THREEUI_CSS_SHA256,
  },
  {
    path: 'src/templates/3d-paper/japanese-3d-paper/sources/ThreeDPaper.tsx.txt',
    bytes: 3185,
