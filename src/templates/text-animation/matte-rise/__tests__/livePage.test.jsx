...
describe('GalleryHeading Matte Rise host', () => {
  it('mounts the rising-diagonal iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <GalleryHeading {...MATTE_RISE_DEFAULT_PROPS} documentSrc={SOURCE_URL} />,
    );
...
describe('Matte Rise LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.matte-rise-page')).toBeTruthy();
