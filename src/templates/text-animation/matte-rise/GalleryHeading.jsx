...
import './matte-rise.css';

export const GALLERY_HEADING_DEFAULTS = { ...MATTE_RISE_DEFAULT_PROPS };

const RISING_DIAGONAL = 'rising-diagonal';
...
function resolveVariant(variant) {
  return variant === RISING_DIAGONAL ? RISING_DIAGONAL : VARIANT_ID;
}
...
/**
 * CSP-safe GalleryHeading host for Matte Rise (`rising-diagonal`).
 * Mounts the focused Neuform document at `/effects/matte-rise.html`.
 */
