...
import './glitch-fall.css';

export const GALLERY_HEADING_DEFAULTS = { ...GLITCH_FALL_DEFAULT_PROPS };

const FALLING_DIAGONAL = 'falling-diagonal';
...
function resolveVariant(variant) {
  return variant === FALLING_DIAGONAL ? FALLING_DIAGONAL : VARIANT_ID;
}
...
/**
 * CSP-safe GalleryHeading host for Glitch Fall (`falling-diagonal`).
 * Mounts the focused Neuform document at `/effects/glitch-fall.html`.
 */
export function GalleryHeading({
  ...
  const background = safeMode === 'light' ? '#f4f7fb' : PAGE_BG;
