...
describe('GalleryHeading Halftone Loop host', () => {
  it('mounts the vertical-loop iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <GalleryHeading {...HALFTONE_LOOP_DEFAULT_PROPS} documentSrc={SOURCE_URL} />,
    );
...
describe('Halftone Loop LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.halftone-loop-page')).toBeTruthy();
