...
describe('GalleryHeading Riso Sweep host', () => {
  it('mounts the horizontal-sweep iframe with the CSP-safe public scene URL', () => {
...
describe('Riso Sweep LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.riso-sweep-page')).toBeTruthy();
