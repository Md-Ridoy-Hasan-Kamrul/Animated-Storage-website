...
export const GALLERY_HEADING_DEFAULTS = { ...RISO_SWEEP_DEFAULT_PROPS };

const HORIZONTAL_SWEEP = 'horizontal-sweep';
...
function resolveVariant(variant) {
  return variant === HORIZONTAL_SWEEP ? HORIZONTAL_SWEEP : VARIANT_ID;
}
...
/**
 * CSP-safe GalleryHeading host for Riso Sweep (`horizontal-sweep`).
 * Mounts the focused Neuform document at `/effects/riso-sweep.html`.
 */
