...
describe('LiquidMetalButton pill host', () => {
  it('mounts the sign-up-pill iframe sandbox with configured defaults', () => {
    const { container } = render(<LiquidMetalButton {...SIGN_UP_PILL_DEFAULT_PROPS} />);
...
describe('Sign up Pill LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.sign-up-pill-liquid-metal-button-page')).toBeTruthy();
