export const TIDEFORM_OUTLINE_RECTANGLE_BUTTONS_PROMPT = `# Integrate <RectangleButtons /> from ThreeUI using its exact source
...
Variant: **Tideform Outline** (\`tideform-outline\`)
Runtime: DOM + CSS
