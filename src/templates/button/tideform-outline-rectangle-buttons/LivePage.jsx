...
import './tideform-outline-rectangle-buttons.css';
import { PAGE_CLASS, SHADER_FRAME_CLASS, TIDEFORM_OUTLINE_DEFAULT_PROPS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <RectangleButtons {...TIDEFORM_OUTLINE_DEFAULT_PROPS} />
      </div>
    </div>
  );
});
