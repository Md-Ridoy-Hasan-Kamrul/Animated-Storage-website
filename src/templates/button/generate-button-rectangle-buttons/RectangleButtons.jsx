...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...GENERATE_BUTTON_DEFAULT_PROPS };

const GENERATE_BUTTON_VARIANT = 'generate-button';
...
function resolveVariant(variant) {
  return variant === GENERATE_BUTTON_VARIANT ? GENERATE_BUTTON_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Generate Button variant.
 * Mounts the focused Neuform document at `/effects/generate-button.html`.
 */
