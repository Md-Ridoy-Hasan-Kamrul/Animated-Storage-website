...
import './rectangle-buttons.css';
import { PAGE_CLASS, RECTANGLE_BUTTONS_DEFAULT_PROPS, SHADER_FRAME_CLASS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <RectangleButtons {...RECTANGLE_BUTTONS_DEFAULT_PROPS} />
      </div>
    </div>
  );
});
