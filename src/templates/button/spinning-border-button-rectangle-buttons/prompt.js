export const SPINNING_BORDER_BUTTON_RECTANGLE_BUTTONS_PROMPT = `# Integrate <RectangleButtons /> from ThreeUI using its exact source
...
Variant: **Spinning Border Button** (\`spinning-border-button\`)
Runtime: DOM + CSS
...
Complete registered source bundle: [https://threeui.com/source-code/spinning-border-button.json](https://threeui.com/source-code/spinning-border-button.json)
...
- \`src/shaders/neuform-isolated/sources/spinning-border-button.html\` — canonical-source · SHA-256 \`d7150ca6ca4ad7975ba183c368b25a5de266e6a018c801b89720b8e8e3fab8a7\`
