...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...SPINNING_BORDER_BUTTON_DEFAULT_PROPS };

const SPINNING_BORDER_BUTTON_VARIANT = 'spinning-border-button';
...
function resolveVariant(variant) {
  return variant === SPINNING_BORDER_BUTTON_VARIANT
    ? SPINNING_BORDER_BUTTON_VARIANT
    : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Spinning Border Button variant.
 * Mounts the focused Neuform document at `/effects/spinning-border-button.html`.
 */
