...
describe('RectangleButtons spinning-border-button host', () => {
  it('mounts the spinning-border-button iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...SPINNING_BORDER_BUTTON_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Spinning Border Button Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.spinning-border-button-rectangle-buttons-page')).toBeTruthy();
