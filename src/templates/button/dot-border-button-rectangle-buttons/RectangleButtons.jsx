...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...DOT_BORDER_BUTTON_DEFAULT_PROPS };

const DOT_BORDER_BUTTON_VARIANT = 'dot-border-button';
...
function resolveVariant(variant) {
  return variant === DOT_BORDER_BUTTON_VARIANT ? DOT_BORDER_BUTTON_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Dot Border Button variant.
 * Mounts the focused Neuform document at `/effects/dot-border-button.html`.
 */
