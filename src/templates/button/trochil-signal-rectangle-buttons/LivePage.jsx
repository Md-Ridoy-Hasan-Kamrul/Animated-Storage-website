...
import './trochil-signal-rectangle-buttons.css';
import { PAGE_CLASS, SHADER_FRAME_CLASS, TROCHIL_SIGNAL_DEFAULT_PROPS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <RectangleButtons {...TROCHIL_SIGNAL_DEFAULT_PROPS} />
      </div>
    </div>
  );
});
