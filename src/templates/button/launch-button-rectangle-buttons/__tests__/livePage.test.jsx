...
describe('RectangleButtons launch-button host', () => {
  it('mounts the launch-button iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...LAUNCH_BUTTON_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Launch Button Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.launch-button-rectangle-buttons-page')).toBeTruthy();
