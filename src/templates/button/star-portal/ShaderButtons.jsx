...
export const SHADER_BUTTONS_DEFAULTS = { ...STAR_PORTAL_DEFAULT_PROPS };

const STAR_PORTAL_VARIANT = 'star-portal';
...
function resolveVariant(variant) {
  return variant === STAR_PORTAL_VARIANT ? STAR_PORTAL_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe ShaderButtons host for the Star Portal variant.
 * Mounts the focused Neuform document at `/effects/star-portal.html`
 * (same isolation as ThreeUI StarPortal / buildFocusedDocument).
 */
