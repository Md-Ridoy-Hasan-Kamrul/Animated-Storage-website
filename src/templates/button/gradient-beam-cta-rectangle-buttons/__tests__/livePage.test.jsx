...
describe('RectangleButtons gradient-beam-cta host', () => {
  it('mounts the gradient-beam-cta iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...GRADIENT_BEAM_CTA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Gradient Beam CTA Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.gradient-beam-cta-rectangle-buttons-page')).toBeTruthy();
