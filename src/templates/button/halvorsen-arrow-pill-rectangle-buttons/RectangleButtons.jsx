...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...HALVORSEN_ARROW_PILL_DEFAULT_PROPS };
...
/**
 * RectangleButtons host for the Halvorsen Arrow Pill selected-page variant.
 * Mirrors ThreeUI: halvorsen-arrow-pill → SelectedPageButton.
 */
