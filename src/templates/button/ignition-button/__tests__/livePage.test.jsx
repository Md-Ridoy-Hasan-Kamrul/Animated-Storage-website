...
describe('ShaderButtons ignition host', () => {
  it('mounts the ignition-button iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <ShaderButtons {...IGNITION_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Ignition LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.ignition-button-page')).toBeTruthy();
