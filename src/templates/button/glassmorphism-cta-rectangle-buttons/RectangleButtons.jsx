...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...GLASSMORPHISM_CTA_DEFAULT_PROPS };

const GLASSMORPHISM_CTA_VARIANT = 'glassmorphism-cta';
...
function resolveVariant(variant) {
  return variant === GLASSMORPHISM_CTA_VARIANT ? GLASSMORPHISM_CTA_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Glassmorphism CTA variant.
 * Mounts the focused Neuform document at `/effects/glassmorphism-cta.html`.
 */
