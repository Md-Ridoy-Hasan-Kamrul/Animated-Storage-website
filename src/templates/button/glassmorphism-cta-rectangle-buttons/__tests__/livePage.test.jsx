...
describe('RectangleButtons glassmorphism-cta host', () => {
  it('mounts the glassmorphism-cta iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...GLASSMORPHISM_CTA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Glassmorphism CTA Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.glassmorphism-cta-rectangle-buttons-page')).toBeTruthy();
