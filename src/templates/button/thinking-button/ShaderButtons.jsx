...
export const SHADER_BUTTONS_DEFAULTS = { ...THINKING_DEFAULT_PROPS };

const THINKING_VARIANT = 'thinking-button';
...
function resolveVariant(variant) {
  return variant === THINKING_VARIANT ? THINKING_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe ShaderButtons host for the Thinking variant.
 * Mounts the focused Neuform document at `/effects/thinking-button.html`
 * (transformThinkingButtonSource + buildFocusedDocument, mode=dark).
 */
