...
import './lumen-cta-rectangle-buttons.css';
import { LUMEN_CTA_DEFAULT_PROPS, PAGE_CLASS, SHADER_FRAME_CLASS } from './constants';
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <div className={SHADER_FRAME_CLASS}>
        <RectangleButtons {...LUMEN_CTA_DEFAULT_PROPS} />
      </div>
    </div>
  );
});
