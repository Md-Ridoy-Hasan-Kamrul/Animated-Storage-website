...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...GRADIENT_PILL_BUTTON_DEFAULT_PROPS };

const GRADIENT_PILL_BUTTON_VARIANT = 'gradient-pill-button';
...
function resolveVariant(variant) {
  return variant === GRADIENT_PILL_BUTTON_VARIANT ? GRADIENT_PILL_BUTTON_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Gradient Pill Button variant.
 * Mounts the focused Neuform document at `/effects/gradient-pill-button.html`.
 */
