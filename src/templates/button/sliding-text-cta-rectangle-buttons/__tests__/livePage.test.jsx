...
describe('RectangleButtons sliding-text-cta host', () => {
  it('mounts the sliding-text-cta iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...SLIDING_TEXT_CTA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Sliding Text CTA Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.sliding-text-cta-rectangle-buttons-page')).toBeTruthy();
