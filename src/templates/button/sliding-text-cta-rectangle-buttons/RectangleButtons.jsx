...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...SLIDING_TEXT_CTA_DEFAULT_PROPS };

const SLIDING_TEXT_CTA_VARIANT = 'sliding-text-cta';
...
function resolveVariant(variant) {
  return variant === SLIDING_TEXT_CTA_VARIANT ? SLIDING_TEXT_CTA_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Sliding Text CTA variant.
 * Mounts the focused Neuform document at `/effects/sliding-text-cta.html`.
 */
