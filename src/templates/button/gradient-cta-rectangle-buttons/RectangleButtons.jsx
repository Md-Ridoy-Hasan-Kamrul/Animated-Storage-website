...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...GRADIENT_CTA_DEFAULT_PROPS };

const GRADIENT_CTA_VARIANT = 'gradient-cta';
...
function resolveVariant(variant) {
  return variant === GRADIENT_CTA_VARIANT ? GRADIENT_CTA_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Gradient CTA variant.
 * Mounts the focused Neuform document at `/effects/gradient-cta.html`.
 */
