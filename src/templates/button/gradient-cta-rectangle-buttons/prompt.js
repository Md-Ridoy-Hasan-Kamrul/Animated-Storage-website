export const GRADIENT_CTA_RECTANGLE_BUTTONS_PROMPT = `# Integrate <RectangleButtons /> from ThreeUI using its exact source
...
Variant: **Gradient CTA** (\`gradient-cta\`)
Runtime: DOM + CSS
...
Complete registered source bundle: [https://threeui.com/source-code/gradient-cta.json](https://threeui.com/source-code/gradient-cta.json)
...
- \`src/shaders/neuform-isolated/sources/gradient-cta.html\` — canonical-source · SHA-256 \`05e611c9ec16848e00ce81e4c8e186167da592c49755408cbc563c2ea611458d\`
