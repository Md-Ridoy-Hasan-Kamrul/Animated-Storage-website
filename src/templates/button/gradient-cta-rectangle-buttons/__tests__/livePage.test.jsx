...
describe('RectangleButtons gradient-cta host', () => {
  it('mounts the gradient-cta iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...GRADIENT_CTA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Gradient CTA Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.gradient-cta-rectangle-buttons-page')).toBeTruthy();
