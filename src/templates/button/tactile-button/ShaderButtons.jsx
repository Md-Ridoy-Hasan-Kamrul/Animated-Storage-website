...
export const SHADER_BUTTONS_DEFAULTS = { ...TACTILE_DEFAULT_PROPS };

const TACTILE_VARIANT = 'tactile-button';
...
function resolveVariant(variant) {
  return variant === TACTILE_VARIANT ? TACTILE_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe ShaderButtons host for the Tactile variant.
 * Mounts the focused Neuform document at `/effects/tactile-button.html`
 * (same isolation as ThreeUI TactileButton / buildFocusedDocument, mode=dark).
 */
