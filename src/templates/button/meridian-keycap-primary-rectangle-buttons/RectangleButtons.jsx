...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...MERIDIAN_KEYCAP_PRIMARY_DEFAULT_PROPS };
...
/**
 * RectangleButtons host for the Meridian Keycap Primary selected-page variant.
 * Mirrors ThreeUI: meridian-keycap-primary → SelectedPageButton.
 */
