/** Meridian Keycap Primary Rectangle Buttons — host + provenance constants. */

export const CARD_ID = 'meridian-keycap-primary-rectangle-buttons';
export const CARD_TITLE = 'Meridian Keycap Primary Rectangle Buttons';
export const PAGE_TITLE = 'Meridian Keycap Primary Rectangle Buttons — Kmotion';
export const DETAIL_FALLBACK = '/templates/meridian-keycap-primary-rectangle-buttons';

export const PAGE_CLASS = 'meridian-keycap-primary-rectangle-buttons-page';
export const PAGE_HTML_CLASS = 'meridian-keycap-primary-rectangle-buttons-html';
export const FRAMED_HTML_CLASS = 'meridian-keycap-primary-rectangle-buttons-framed';
...
export const VARIANT_ID = 'meridian-keycap-primary';
export const THEME_ID = 'meridian';
export const DEFAULT_MODE = 'dark';
export const BUTTON_LABEL = 'Start free';
...
export const MERIDIAN_KEYCAP_PRIMARY_DEFAULT_PROPS = {
...
const SRC = 'src/templates/button/meridian-keycap-primary-rectangle-buttons/sources';
...
export const PREVIEW_STILL_DISK =
  'public/images/Assets Meridian Keycap Primary Rectangle Buttons/MeridianKeycapPrimaryRectangleButtons.png';
