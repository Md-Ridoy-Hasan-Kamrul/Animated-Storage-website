...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...FLOATING_DOTS_CTA_DEFAULT_PROPS };

const FLOATING_DOTS_CTA_VARIANT = 'floating-dots-cta';
...
function resolveVariant(variant) {
  return variant === FLOATING_DOTS_CTA_VARIANT ? FLOATING_DOTS_CTA_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe RectangleButtons host for the Floating Dots CTA variant.
 * Mounts the focused Neuform document at `/effects/floating-dots-cta.html`.
 */
