...
describe('RectangleButtons floating-dots-cta host', () => {
  it('mounts the floating-dots-cta iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <RectangleButtons {...FLOATING_DOTS_CTA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Floating Dots CTA Rectangle Buttons LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.floating-dots-cta-rectangle-buttons-page')).toBeTruthy();
