...
describe('ShaderButtons plasma host', () => {
  it('mounts the plasma-button iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <ShaderButtons {...PLASMA_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Plasma LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.plasma-button-page')).toBeTruthy();
