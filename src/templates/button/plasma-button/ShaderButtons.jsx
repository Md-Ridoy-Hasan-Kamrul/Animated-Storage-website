...
export const SHADER_BUTTONS_DEFAULTS = { ...PLASMA_DEFAULT_PROPS };

const PLASMA_VARIANT = 'plasma-button';
...
function resolveVariant(variant) {
  return variant === PLASMA_VARIANT ? PLASMA_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe ShaderButtons host for the Plasma variant.
 * Mounts the focused Neuform document at `/effects/plasma-button.html`
 * (same isolation as ThreeUI PlasmaButton / buildFocusedDocument, mode=dark).
 */
