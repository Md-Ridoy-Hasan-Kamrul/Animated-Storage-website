...
export const SHADER_BUTTONS_DEFAULTS = { ...INDUCTION_DEFAULT_PROPS };

const INDUCTION_VARIANT = 'induction-button';
...
function resolveVariant(variant) {
  return variant === INDUCTION_VARIANT ? INDUCTION_VARIANT : VARIANT_ID;
}
...
/**
 * CSP-safe ShaderButtons host for the Induction variant.
 * Mounts the focused Neuform document at `/effects/induction-button.html`
 * (same isolation as ThreeUI InductionButton / buildFocusedDocument, mode=dark).
 */
