...
describe('ShaderButtons induction host', () => {
  it('mounts the induction-button iframe with the CSP-safe public scene URL', () => {
    const { container } = render(
      <ShaderButtons {...INDUCTION_DEFAULT_PROPS} sourceUrl={SOURCE_URL} />,
    );
...
describe('Induction LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.induction-button-page')).toBeTruthy();
