...
describe('LiquidMetalButton circle host', () => {
  it('mounts the liquid-orb iframe sandbox with configured defaults', () => {
    const { container } = render(<LiquidMetalButton {...LIQUID_ORB_DEFAULT_PROPS} />);
...
describe('Liquid Orb LivePage', () => {
  it('mounts the shader frame host without a back control in embed chrome', () => {
    ...
    expect(container.querySelector('.liquid-orb-liquid-metal-button-page')).toBeTruthy();
