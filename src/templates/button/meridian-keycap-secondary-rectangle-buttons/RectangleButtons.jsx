...
export const RECTANGLE_BUTTONS_DEFAULTS = { ...MERIDIAN_KEYCAP_SECONDARY_DEFAULT_PROPS };
...
/**
 * RectangleButtons host for the Meridian Keycap Secondary selected-page variant.
 * Mirrors ThreeUI: meridian-keycap-secondary → SelectedPageButton.
 */
