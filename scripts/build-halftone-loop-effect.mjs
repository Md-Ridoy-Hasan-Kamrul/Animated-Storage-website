...
const VARIANT_KEY = 'vertical-loop';
const EFFECT_ID = 'halftone-loop';
  ...
  JSON.stringify(
    {
      ...
      checks: {
        oneWall: scriptBody.includes('ONE WALL'),
        twelvePlates: scriptBody.includes('TWELVE PLATES'),
        halftone: scriptBody.includes("FIELD = 'halftone'"),
        axis90: scriptBody.includes('axis: 90,'),
        didone: scriptBody.includes('Didot'),
