...
const VARIANT_KEY = 'falling-diagonal';
const EFFECT_ID = 'glitch-fall';
  ...
  JSON.stringify(
    {
      ...
      checks: {
        signalLost: scriptBody.includes('SIGNAL LOST'),
        glitch: scriptBody.includes("FIELD = 'glitch'"),
        noSpring: scriptBody.includes('SPRING = 0'),
        directionNeg: scriptBody.includes('* -1'),
