...
export const TEMPLATES = [
  ...
  'rectangle-buttons',
  'launch-button-rectangle-buttons',
  'dot-border-button-rectangle-buttons',
  'floating-dots-cta-rectangle-buttons',
  'sliding-text-cta-rectangle-buttons',
  'gradient-beam-cta-rectangle-buttons',
  'gradient-pill-button-rectangle-buttons',
  'generate-button-rectangle-buttons',
  'glassmorphism-cta-rectangle-buttons',
  'spinning-border-button-rectangle-buttons',
  'gradient-cta-rectangle-buttons',
  'lumen-cta-rectangle-buttons',
  'trochil-signal-rectangle-buttons',
  'tideform-outline-rectangle-buttons',
  'meridian-keycap-primary-rectangle-buttons',
  'meridian-keycap-secondary-rectangle-buttons',
  'halvorsen-arrow-pill-rectangle-buttons',
  'ember-keycap-rectangle-buttons',
  'bloom-outline-button-rectangle-buttons',
  'play-circle-liquid-metal-button',
  'sign-up-pill-liquid-metal-button',
  'liquid-orb-liquid-metal-button',
  'star-portal',
  'ignition-button',
  'induction-button',
  'plasma-button',
  ...
  'thailand-japanese-tower-landscape',
