...
var RING = {
  ...
  phase: 87             /* psi of tile 0 at t = 0 (deg)                  */
};

var DUR = 15.015;       /* one full revolution = a seamless loop */

var HEAD = [
  { s:'SIGNAL LOST', top:930,  w:1622, fill:'#ff2f6d' },
  { s:'IMAGE HOLDING', top:1114, w:1917, fill:'#f2f2f8' }
];
...
var HEAD_TRACK = 0;   /* headline tracking, in cap heights */
var HEAD_STYLE = 'glitch';
var HEAD_SHADOW = '#0b0b12';  /* riso: the plate under the ink */
var HEAD_GHOST = ['#ff2f6d','#00e6ff'];  /* glitch: the two channel ghosts */
var PLATES = ["#0b0b12","#ff2f6d","#00e6ff","#13f28a","#f2f2f8","#7a1bff","#101018","#ff7a1a","#141a2e","#e01f52","#1a1a26","#0ac2d8"];
var FIELD = 'glitch';       /* which painter shades the plates */
var EASE = 0.12;        /* seconds for the orbit to reach hover speed */
