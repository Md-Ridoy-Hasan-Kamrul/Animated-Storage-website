...
var RING = {
  ...
  axis: 90,           /* screen angle of the major axis (deg, y down)  */
  n: 12,                /* tiles                                         */
  ...
  phase: 0             /* psi of tile 0 at t = 0 (deg)                  */
};

var DUR = 15.015;       /* one full revolution = a seamless loop */

var HEAD = [
  { s:'ONE WALL', top:930,  w:1132, fill:'#c0402c' },
  { s:'TWELVE PLATES', top:1114, w:1840, fill:'#f2efe8' }
];
var HEAD_CAP = 142;     /* authored headline cap height */
var HEAD_MID = 1093;    /* authored vertical centre of the two-line block */
var HEAD_SIZE = 1.25;   /* headline size multiplier */
var HEAD_WEIGHT = '400'; /* headline weight */
var HEAD_TRACK = 0.06;   /* headline tracking, in cap heights */
var HEAD_STYLE = 'halftone';
var HEAD_SHADOW = '#12110f';  /* riso: the plate under the ink */
var HEAD_GHOST = ['#ff2f6d','#00e6ff'];  /* glitch: the two channel ghosts */
var PLATES = ["#12110f","#f2efe8","#1c1b18","#e4e0d7","#2b2a26","#d6d1c6","#0a0a09","#faf8f3","#1f1e1a","#eae6dd","#161513","#c0402c"];
var FIELD = 'halftone';       /* which painter shades the plates */
var EASE = 0.55;        /* seconds for the orbit to reach hover speed */
var SPRING = 0, SPRING_K = 26, SPRING_D = 5.7;

var SANS = 'Didot,"Bodoni 72","Bodoni MT","Playfair Display",Georgia,serif';
...
/* ------------------------------------------------------------------ *
 * Tile artwork — twelve flat plates under a procedural noise field
 * ------------------------------------------------------------------ */
...
function buildTextures(){
  ...
  for (var i=0;i<ART.length;i++){
    ...
    ART[i](x);
    /* each field painter lays its own grain, at the weight its style wants */
    front.push(c);
