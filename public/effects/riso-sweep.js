...
var RING = {
  ...
  axis: 0,           /* screen angle of the major axis (deg, y down)  */
  n: 12,                /* tiles                                         */
  ...
  phase: 90             /* psi of tile 0 at t = 0 (deg)                  */
};

var DUR = 15.015;       /* one full revolution = a seamless loop */

var HEAD = [
  { s:'PRINTS FROM', top:930,  w:1506, fill:'#e0b64a' },
  { s:'THE FLAT FILES', top:1114, w:1917, fill:'#f4e9d2' }
];
var HEAD_CAP = 142;     /* authored headline cap height */
var HEAD_MID = 1093;    /* authored vertical centre of the two-line block */
var HEAD_SIZE = 1.2;   /* headline size multiplier */
var HEAD_WEIGHT = '700'; /* headline weight */
var HEAD_TRACK = 0.03;   /* headline tracking, in cap heights */
var HEAD_STYLE = 'riso';
var HEAD_SHADOW = '#6d2a16';  /* riso: the plate under the ink */
var HEAD_GHOST = ['#ff2f6d','#00e6ff'];  /* glitch: the two channel ghosts */
var PLATES = ["#e0b64a","#b1512a","#6d7638","#ecdfc2","#2f6b66","#8a3a2b","#d69b3e","#3c4630","#c06e3a","#e6d3a8","#546d76","#7a4726"];
var FIELD = 'riso';       /* which painter shades the plates */
var EASE = 0.9;        /* seconds for the orbit to reach hover speed */
var SPRING = 0, SPRING_K = 26, SPRING_D = 5.7;

var SANS = '"Iowan Old Style","Palatino Linotype",Palatino,"Book Antiqua",Georgia,serif';
